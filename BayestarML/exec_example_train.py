...
def main():
    ...
    trace = train(model, "Dataset_D_training_with_Xiong/HBNN_rad_4param_L_3000_draws_4_chains_15_nodes_sig_015_seed_2695.nc", draw=3000, chains=4)
    ...
    # trace = train(model, "Dataset_D_training_with_Xiong/GP_rad_4param_L_3000_draws_4_chains_100_50_seed_2805.nc", draw=3000, chains=4)
    ...
    diagnostic_table.to_csv('Dataset_D_training_with_Xiong/radius_prediction_results_HBNN_3000_seed_2695.tsv', sep='\t', index=False)
    ...
    # plot_output_base = 'Dataset_D_training_with_Xiong/GP_radius_4param_L_3000_draws_4_chains_100_50_seed_2805'
    plot_output_base = 'Dataset_D_training_with_Xiong/HBNN_radius_4param_L_3000_draws_4_chains_15_nodes_sig_015_seed_2695'
