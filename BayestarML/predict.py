...
def predict4(X, X_er, target, test=False):
    ...
    if target == 'mass':
        ...
        gp4_trace = az.from_netcdf('Dataset_D_training_with_Xiong/GP_mass_4param_L_3000_draws_4_chains_100_50.nc')
        ...
        hbnn4_trace = az.from_netcdf('Dataset_D_training_with_Xiong/HBNN_mass_4param_L_3000_draws_4_chains_15_nodes_sig_015.nc')
